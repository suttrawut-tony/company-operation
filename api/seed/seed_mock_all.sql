...
VALUES
  -- ── Jan 2026 ──
  ('bbb10001-0001-0001-0001-000000000101',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-001' LIMIT 1),
   'EXP26010001', '2026-01-10', 'reimbursement', 'approved',
   'ค่าเดินทางสำรวจหน้างานภูเก็ต', 12500, '522602',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-01-11 09:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000102',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-002' LIMIT 1),
   'EXP26010002', '2026-01-18', 'reimbursement', 'approved',
   'ค่าอุปกรณ์ทดสอบ Sonar ระยอง', 45000, '522709',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-01-19 10:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000103',
   '11111111-1111-1111-1111-111111111111', NULL,
   'EXP26010003', '2026-01-25', 'reimbursement', 'approved',
   'ค่าเช่าสำนักงานเดือน ม.ค.', 85000, '522801',
   '2ad7260e-a703-4a04-bc04-ccd0cc456894', '2026-01-26 09:00:00+07'),

  -- ── Feb 2026 ──
  ('bbb10001-0001-0001-0001-000000000201',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-004' LIMIT 1),
   'EXP26020001', '2026-02-05', 'reimbursement', 'approved',
   'ค่า GPS Module สมุทรปราการ', 68000, '522602',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-02-06 09:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000202',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-005' LIMIT 1),
   'EXP26020002', '2026-02-14', 'reimbursement', 'approved',
   'ค่าน้ำมันรถเดินทางชลบุรี Satcom', 5800, '522701',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-02-15 10:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000203',
   '11111111-1111-1111-1111-111111111111', NULL,
   'EXP26020003', '2026-02-25', 'reimbursement', 'approved',
   'ค่าเช่าสำนักงานเดือน ก.พ.', 85000, '522801',
   '2ad7260e-a703-4a04-bc04-ccd0cc456894', '2026-02-26 09:00:00+07'),

  -- ── Mar 2026 ──
  ('bbb10001-0001-0001-0001-000000000301',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-008' LIMIT 1),
   'EXP26030001', '2026-03-08', 'reimbursement', 'approved',
   'ค่าอุปกรณ์ CCTV แหลมฉบัง batch 1', 125000, '522602',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-03-09 09:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000302',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-001' LIMIT 1),
   'EXP26030002', '2026-03-15', 'reimbursement', 'approved',
   'ค่าที่พักทีมติดตั้ง Marine Nav ภูเก็ต 5 คืน', 22500, '522602',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-03-16 09:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000303',
   '11111111-1111-1111-1111-111111111111', NULL,
   'EXP26030003', '2026-03-25', 'reimbursement', 'approved',
   'ค่าเช่าสำนักงานเดือน มี.ค.', 85000, '522801',
   '2ad7260e-a703-4a04-bc04-ccd0cc456894', '2026-03-26 09:00:00+07'),

  -- ── Apr 2026 ──
  ('bbb10001-0001-0001-0001-000000000401',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-006' LIMIT 1),
   'EXP26040001', '2026-04-03', 'reimbursement', 'approved',
   'ค่าอุปกรณ์ AIS Repeater สุราษฎร์ธานี', 95000, '522602',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-04-04 09:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000402',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-010' LIMIT 1),
   'EXP26040002', '2026-04-18', 'reimbursement', 'approved',
   'ค่าเดินทางสงขลา Echo Sounder Maintenance', 18000, '522701',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-04-19 10:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000403',
   '11111111-1111-1111-1111-111111111111', NULL,
   'EXP26040003', '2026-04-25', 'reimbursement', 'approved',
   'ค่าเช่าสำนักงานเดือน เม.ย.', 85000, '522801',
   '2ad7260e-a703-4a04-bc04-ccd0cc456894', '2026-04-26 09:00:00+07'),

  -- ── May 2026 ──
  ('bbb10001-0001-0001-0001-000000000501',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-003' LIMIT 1),
   'EXP26050001', '2026-05-07', 'reimbursement', 'approved',
   'ค่าอุปกรณ์ Radar Upgrade กรุงเทพ', 180000, '522602',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-05-08 09:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000502',
   '11111111-1111-1111-1111-111111111111',
   (SELECT id FROM projects WHERE code = 'SDA-2026-011' LIMIT 1),
   'EXP26050002', '2026-05-20', 'reimbursement', 'approved',
   'ค่าน้ำมัน+ทางด่วน ไปสำรวจ VTS มาบตาพุด', 7200, '522701',
   '75b4f523-f342-4c11-97b5-26757ccf1449', '2026-05-21 10:00:00+07'),
  ('bbb10001-0001-0001-0001-000000000503',
   '11111111-1111-1111-1111-111111111111', NULL,
   'EXP26050003', '2026-05-25', 'reimbursement', 'approved',
   'ค่าเช่าสำนักงานเดือน พ.ค.', 85000, '522801',
   '2ad7260e-a703-4a04-bc04-ccd0cc456894', '2026-05-26 09:00:00+07'),

  -- ── Jun 2026 (existing + more) ──
